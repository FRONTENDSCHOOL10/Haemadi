const icons = {
  ...
  musicNote: { name: 'musicNote', width: 17, height: 25, color: '#2D7EB9' },
  musicNote_selected: { name: 'musicNote', width: 17, height: 25, color: '#FFFFFF' },
  ...
  navPerson_darkBg: { name: 'navBottle', width: 39, height: 41, color: '#fff' },
  navPerson_darkBg_selected: { name: 'navBottle', width: 39, height: 41, color: '#FBE517'},
